...

{
    public function index(Request $request)
    {
        ...
        $inquery = Return_ekspedisi::orderBy('id', 'DESC');
        ...
        return view('admin.laporan_return.index', compact('inquery'));
        // } else {
    ...
    public function print_return(Request $request)
    {
        ...
        $query = Return_ekspedisi::orderBy('id', 'DESC');
        ...
        $pdf = PDF::loadView('admin.laporan_return.print', compact('inquery'));
        return $pdf->stream('Laporan_Return_Ekspedisi.pdf');
        // } else {
        //     // tidak memiliki akses
        //     return back()->with('error', array('Anda tidak memiliki akses'));
        // }
