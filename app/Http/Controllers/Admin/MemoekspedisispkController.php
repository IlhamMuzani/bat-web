            ...
            case 'Memo Perjalanan':
                ...
                $cetakpdf = Memo_ekspedisi::create(array_merge(
                    ...
                    [
                        ...
                        'km_awal_akhir' => $request->km_awal_akhir,
                        ...
                        'uang_jaminan' => $request->deposit_driver ? str_replace('.', '', $request->uang_jaminan) : 0,
                        ...
                        // 'harga' => $request->harga,
                        'kode_memo' => $this->kode(),
                        'qrcode_memo' => 'https://batlink.id/memo_ekspedisispk/' . $kode,
