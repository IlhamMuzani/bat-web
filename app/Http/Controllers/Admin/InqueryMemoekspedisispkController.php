...
class InqueryMemoekspedisispkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($kategori === 'Memo Perjalanan') {
            ...
            return view('admin.inquery_memoekspedisispk.index', compact('memoekspedisiJson', 'saldoTerakhir', 'inquery'));
    ...
    public function cetak_memoekspedisifilter(Request $request)
    {
        ...
        $pdf->loadView('admin.inquery_memoekspedisispk.cetak_pdffilter', compact('memos'));
        $pdf->setPaper('folio');
    ...
    public function update(Request $request, $id)
    {
        ...
        return view('admin.inquery_memoekspedisispk.show', compact('cetakpdf'));
    }
    ...
    public function hapusmemo($id)
    {
        ...
        $spk = Spk::where('id', $memo->spk_id)->decrement('voucher');
