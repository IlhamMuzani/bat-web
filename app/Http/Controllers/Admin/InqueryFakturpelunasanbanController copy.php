    ...
    public function update(Request $request, $id)
    {
        ...
        foreach ($data_pembelians as $data_pesanan) {
            ...
            if ($detailId) {
                ...
                // Update status memo tambahan (jika ada)
                if ($data_pesanan['memotambahan_id']) {
                    Memotambahan::where('id', $data_pesanan['memotambahan_id'])->update(['status_memo' => 'aktif', 'status' => 'selesai']);
                }
            } else {
