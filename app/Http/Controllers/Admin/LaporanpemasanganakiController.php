...
class LaporanpemasanganakiController extends Controller

{
    public function index(Request $request)
    {
        if (auth()->check() && auth()->user()->menu['laporan pemasangan part']) {
            ...
            $inquery = Pemasangan_aki::orderBy('id', 'DESC');
            ...
            return view('admin.laporan_pemasanganaki.index', compact('inquery'));
        } else {
    ...
    public function print_pemasanganaki(Request $request)
    {
        if (auth()->check() && auth()->user()->menu['laporan pemasangan part']) {
            ...
            $query = Pemasangan_aki::orderBy('id', 'DESC');
            ...
            $pdf = PDF::loadView('admin.laporan_pemasanganaki.print', compact('inquery'));
