    ...
    public function store(Request $request)
    {
        ...
        switch ($kategori) {
            case 'Memo Perjalanan':
                ...
                $validasi_pelanggan = Validator::make(
                    ...
                    [
                        ...
                        // 'uang_jalan' => 'numeric'
                        // 'deposit_driver' => 'required|numeric|min:50000',
                    ...
                    [
                        ...
                        // 'deposit_driver.min' => 'Deposit sopir tidak boleh kurang dari 50,000.',
                    ]
                );
            ...
            case 'Memo Borong':
                ...
                $validator = Validator::make(
                    ...
                    [
                        ...
                        // 'harga_rute.numeric' => 'Uang jalan harus berupa angka',
                    ]
                );
                ...
                Pengeluaran_kaskecil::create([
                    ...
                    'kendaraan_id' => $request->kendaraan_id,
                    'keterangan' => $request->keterangan,
                    'grand_total' => str_replace('.', '', $request->totalrute),
                    'jam' => $tanggal1->format('H:i:s'),
                    'tanggal' => $format_tanggal,
                    'tanggal_awal' => $tanggal,
                    'qrcode_return' => 'https://batlink.id/pengeluaran_kaskecil/' . $kodepengeluaran,
                ...
                Detail_pengeluaran::create([
                    ...
                    'keterangan' => $request->keterangan,
                    'nominal' => str_replace('.', '', $request->totalrute),
                    'status' => 'pending',
                ]);
            ...
            case 'Memo Tambahan':
                ...
                if ($validator->fails()) {
                    $error_pelanggans[] = $validator->errors()->first('memo_ekspedisi_id');
                }
                ...
                if ($request->has('keterangan_tambahan')) {
                    for ($i = 0; $i < count($request->keterangan_tambahan); $i++) {
                        ...
                        // $validator_produk = Validator::make($request->all(), [
                        //     'keterangan_tambahan.' . $i => 'required',
                        //     'nominal_tambahan.' . $i => 'required|numeric', // Adding numeric validation
                        // ], [
                        //     'nominal_tambahan.' . $i . '.numeric' => 'Nominal tambahan nomor ' . ($i + 1) . ' harus berupa angka',
                        // ]);
