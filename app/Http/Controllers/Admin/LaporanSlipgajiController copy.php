...
class LaporanSlipgajiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $inquery = Detail_gajikaryawan::where('kategori', 'Mingguan');
        ...
        return view('admin.laporan_slipgaji.index', compact('inquery'));
        // } else {
    ...
    public function print_slipgaji(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan penerimaan kas kecil']) {
        ...
        $pdf = PDF::loadView('admin.laporan_slipgaji.print', compact('inquery'));
    ...
    public function show($id)
    {
        ...
        $pdf = PDF::loadView('admin.laporan_slipgaji.cetak_pdf', compact('cetakpdf'));
