...
<li class="nav-item {{ request()->is('admin/barang*') || request()->is('admin/satuan*') || request()->is('admin/driver*') || request()->is('admin/tarif*') || request()->is('admin/potongan_memo*') || request()->is('admin/biaya_tambahan*') || request()->is('admin/rute_perjalanan*') || request()->is('admin/karyawan*') || request()->is('admin/user*') || request()->is('admin/akses*') || request()->is('admin/departemen*') || request()->is('admin/supplier*') || request()->is('admin/pelanggan*') || request()->is('admin/kendaraan') || request()->is('admin/ban') || request()->is('admin/golongan') || request()->is('admin/divisi') || request()->is('admin/jenis_kendaraan') || request()->is('admin/ukuran_ban') || request()->is('admin/merek_ban') || request()->is('admin/type_ban') || request()->is('admin/nokir') || request()->is('admin/stnk') || request()->is('admin/sparepart') ? 'menu-open' : '' }}">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="{{ url('admin/departemen') }}" class="nav-link {{ request()->is('admin/departemen*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/jenis_kendaraan') }}" class="nav-link {{ request()->is('admin/jenis_kendaraan*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/golongan') }}" class="nav-link {{ request()->is('admin/golongan*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/kendaraan') }}" class="nav-link {{ request()->is('admin/kendaraan*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/ukuran_ban') }}" class="nav-link {{ request()->is('admin/ukuran_ban*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/merek_ban') }}" class="nav-link {{ request()->is('admin/merek_ban*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/type_ban') }}" class="nav-link {{ request()->is('admin/type_ban*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/rute_perjalanan') }}" class="nav-link {{ request()->is('admin/rute_perjalanan*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        {{-- @if (auth()->check() && auth()->user()->menu['rute perjalanan']) --}}
        <li class="nav-item">
            <a href="{{ url('admin/biaya_tambahan') }}" class="nav-link {{ request()->is('admin/biaya_tambahan*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                <p style="font-size: 14px;">Biaya Tambahan</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ url('admin/potongan_memo') }}" class="nav-link {{ request()->is('admin/potongan_memo*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
...
->whereDate('expired_stnk', '<', $twoWeeksLater) ->get();
    ...
    ->whereDate('masa_berlaku', '<', $twoWeeksLater) ->get();
        ...
        <li class="nav-item {{ request()->is('admin/km*') || request()->is('admin/perpanjangan_stnk*') || request()->is('admin/perpanjangan_kir*') || request()->is('admin/pemasangan_ban*') || request()->is('admin/pelepasan_ban*') || request()->is('admin/pemasangan_part*') || request()->is('admin/penggantian_oli*') || request()->is('admin/status_perjalanan*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->is('admin/km*') || request()->is('admin/perpanjangan_stnk*') || request()->is('admin/perpanjangan_kir*') || request()->is('admin/pemasangan_ban*') || request()->is('admin/pelepasan_ban*') || request()->is('admin/pemasangan_part*') || request()->is('admin/penggantian_oli*') || request()->is('admin/status_perjalanan*') ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/perpanjangan_stnk') }}" class="nav-link {{ request()->is('admin/perpanjangan_stnk*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/perpanjangan_kir') }}" class="nav-link {{ request()->is('admin/perpanjangan_kir*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/pemasangan_ban') }}" class="nav-link {{ request()->is('admin/pemasangan_ban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/pelepasan_ban') }}" class="nav-link {{ request()->is('admin/pelepasan_ban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/pemasangan_part') }}" class="nav-link {{ request()->is('admin/pemasangan_part*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/penggantian_oli') }}" class="nav-link {{ request()->is('admin/penggantian_oli*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/status_perjalanan') }}" class="nav-link {{ request()->is('admin/status_perjalanan*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
    ...
    request()->is('admin/pembelian_part*')
        ...
        request()->is('admin/pembelian_part*')
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/pembelian_ban') }}" class="nav-link {{ request()->is('admin/pembelian_ban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/pembelian_part') }}" class="nav-link {{ request()->is('admin/pembelian_part*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                {{-- @endif --}}
                <li class="nav-item">
                    <a href="{{ url('admin/memo_ekspedisi') }}" class="nav-link {{ request()->is('admin/memo_ekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                        <p style="font-size: 14px;">Memo Ekspedisi</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('admin/faktur_ekspedisi') }}" class="nav-link {{ request()->is('admin/faktur_ekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                {{-- @endif --}}
                <li class="nav-item">
                    <a href="{{ url('admin/tagihan_ekspedisi') }}" class="nav-link {{ request()->is('admin/tagihan_ekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                        <p style="font-size: 14px;">Invoice Faktur Ekspedisi</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('admin/pilih_returnekspedisi') }}" class="nav-link {{ request()->is('admin/pilih_returnekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                        <p style="font-size: 14px;">Return Barang Ekspedisi</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('admin/faktur_pelunasan') }}" class="nav-link {{ request()->is('admin/faktur_pelunasan*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
    ...
    request()->is('admin/inquery_penerimaankaskecil*')
        ...
        request()->is('admin/inquery_penerimaankaskecil*')
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/penerimaan_kaskecil') }}" class="nav-link {{ request()->is('admin/penerimaan_kaskecil*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                        <p style="font-size: 14px;">Penerimaan Kas Kecil</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('admin/deposit_driver') }}" class="nav-link {{ request()->is('admin/deposit_driver*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_penerimaankaskecil') }}" class="nav-link {{ request()->is('admin/inquery_penerimaankaskecil*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_depositdriver') }}" class="nav-link {{ request()->is('admin/inquery_depositdriver*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_updatekm') }}" class="nav-link {{ request()->is('admin/inquery_updatekm*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_pembelianban') }}" class="nav-link {{ request()->is('admin/inquery_pembelianban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_pembelianpart') }}" class="nav-link {{ request()->is('admin/inquery_pembelianpart*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_pemasanganban') }}" class="nav-link {{ request()->is('admin/inquery_pemasanganban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_pelepasanban') }}" class="nav-link {{ request()->is('admin/inquery_pelepasanban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_pemasanganpart') }}" class="nav-link {{ request()->is('admin/inquery_pemasanganpart*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_penggantianoli') }}" class="nav-link {{ request()->is('admin/inquery_penggantianoli*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_perpanjanganstnk') }}" class="nav-link {{ request()->is('admin/inquery_perpanjanganstnk*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_perpanjangankir') }}" class="nav-link {{ request()->is('admin/inquery_perpanjangankir*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                @if (auth()->check() && auth()->user()->karyawan->id === 1)
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_pilihmemo') }}" class="nav-link {{ request()->is('admin/inquery_pilihmemo*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_fakturekspedisi') }}" class="nav-link {{ request()->is('admin/inquery_fakturekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_tagihanekspedisi') }}" class="nav-link {{ request()->is('admin/inquery_tagihanekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/pilih_inqueryreturnekspedisi') }}" class="nav-link {{ request()->is('admin/pilih_inqueryreturnekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/inquery_fakturpelunasan') }}" class="nav-link {{ request()->is('admin/inquery_fakturpelunasan*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item {{ request()->is('admin/laporan_pph*') || request()->is('admin/laporan_pelunasan*') || request()->is('admin/pilih_laporanreturn*') || request()->is('admin/laporan_tagihanekspedisi*') || request()->is('admin/laporan_fakturekspedisi*') || request()->is('admin/laporan_depositdriver*') || request()->is('admin/pilihlaporanmemo*') || request()->is('admin/laporan_penerimaankaskecil*') || request()->is('admin/laporan_pembelianban*') || request()->is('admin/laporan_pembelianpart*') || request()->is('admin/laporan_pemasanganban*') || request()->is('admin/laporan_pelepasanban*') || request()->is('admin/laporan_pemasanganpart*') || request()->is('admin/laporan_penggantianoli*') || request()->is('admin/laporan_updatekm*') || request()->is('admin/laporan_statusperjalanan*') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_pembelianban') }}" class="nav-link {{ request()->is('admin/laporan_pembelianban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_pembelianpart') }}" class="nav-link {{ request()->is('admin/laporan_pembelianpart*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_pemasanganban') }}" class="nav-link {{ request()->is('admin/laporan_pemasanganban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_pelepasanban') }}" class="nav-link {{ request()->is('admin/laporan_pelepasanban*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_pemasanganpart') }}" class="nav-link {{ request()->is('admin/laporan_pemasanganpart*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_penggantianoli') }}" class="nav-link {{ request()->is('admin/laporan_penggantianoli*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_updatekm') }}" class="nav-link {{ request()->is('admin/laporan_updatekm*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_statusperjalanan') }}" class="nav-link {{ request()->is('admin/laporan_statusperjalanan*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_penerimaankaskecil') }}" class="nav-link {{ request()->is('admin/laporan_penerimaankaskecil*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                {{-- @if (auth()->check() && auth()->user()->menu['laporan penerimaan kas kecil']) --}}
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_depositdriver') }}" class="nav-link {{ request()->is('admin/laporan_depositdriver*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/pilihlaporanmemo') }}" class="nav-link {{ request()->is('admin/pilihlaporanmemo*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                {{-- @if (auth()->check() && auth()->user()->menu['laporan penerimaan kas kecil']) --}}
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_fakturekspedisi') }}" class="nav-link {{ request()->is('admin/laporan_fakturekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                {{-- @if (auth()->check() && auth()->user()->menu['laporan penerimaan kas kecil']) --}}
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_pph') }}" class="nav-link {{ request()->is('admin/laporan_pph*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_tagihanekspedisi') }}" class="nav-link {{ request()->is('admin/laporan_tagihanekspedisi*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                        <p style="font-size: 14px;">Laporan Tagihan Ekspedisi
                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('admin/pilih_laporanreturn') }}" class="nav-link {{ request()->is('admin/pilih_laporanreturn*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
                        <p style="font-size: 14px;">Laporan Return Ekspedisi
                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('admin/laporan_pelunasan') }}" class="nav-link {{ request()->is('admin/laporan_pelunasan*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon" style="font-size: 12px;"></i>
