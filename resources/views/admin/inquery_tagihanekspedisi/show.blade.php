                    ...
                    @if ($cetakpdf->kategori == 'PPH')
                        <tr>
                            <td>
                                Pembayaran <br>
                                <span>
                                    Bank BCA No. Rek. 1319988899 a.n PT. Bina Anugerah Transindo
                                </span>
                            </td>
                        </tr>
                    @else
                        <tr>
                            <td>
                                Pembayaran <br>
                                <span>
                                    Bank BCA No. Rek. 1314909090 a.n Eko Soerjono / Djohan Wahyudi
                                </span>
                            </td>
                        </tr>
                    @endif
...
<div class="container">
    ...
    <a href="{{ url('admin/inquery_tagihanekspedisi') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali
    </a>
