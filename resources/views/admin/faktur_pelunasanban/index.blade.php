...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/faktur_pelunasanban') }}">Faktur pelunasan
                                Pembelian
                                Ban</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/faktur_pelunasanban') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody id="tabel-pembelian">
                                <tr id="pembelian-0">
                                    ...
                                    <td hidden>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="pembelian_ban_id-0"
                                                name="pembelian_ban_id[]">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly
                                                type="text" class="form-control" id="kode_pembelian_ban-0"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly
                                                type="text" class="form-control" id="tanggal_pembelian-0"
        ...
        <div class="modal fade" id="tableBan" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Data Faktur Pembelian Ban</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        ...
        function itemPembelian(urutan, key, value = null) {
            ...
            item_pembelian += '<input type="text" class="form-control" id="pembelian_ban_id-' + urutan +
                '" name="pembelian_ban_id[]" value="' + pembelian_ban_id + '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
            ...
            item_pembelian +=
                ...
                urutan +
                '" name="kode_pembelian_ban[]" value="' + kode_pembelian_ban + '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
    ...
    <script>
        ...
        function getFaktur(rowIndex) {
            ...
            var kodeFakturSudahAda = cekKodeFakturSudahAda(kode_pembelian_ban);
        ...
        function cekKodeFakturSudahAda(kodeFaktur) {
            var kodeFakturInputs = $('[id^=kode_pembelian_ban-]').map(function() {
                return $(this).val();
            }).get();
