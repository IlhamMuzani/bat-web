...
<body style="margin: 0; padding: 0;">
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 0px; font-size: 15px;">Kode Akun</td>
            <td class="td" style="text-align: left; padding: 0px; font-size: 15px;">Nama Akun</td>
...
<div class="container">
    {{-- <a href="{{ url('admin/tablepengeluaran') }}" class="blue-button">Kembali</a> --}}
    <a href="{{ url('admin/inquery_pengeluarankaskecil') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali
    </a>
