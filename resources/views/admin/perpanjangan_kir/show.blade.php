...
<body style="margin: 0; padding: 0;">
    <div id="logo-container">
        <img src="{{ asset('storage/uploads/gambar_logo/Logo.png') }}" alt="Java Line" width="70" height="35">
    </div>
    <br>
...
<div class="container">
    <a href="{{ url('admin/perpanjangan_kir') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/perpanjangan_kir/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
