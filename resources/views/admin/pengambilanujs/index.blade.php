...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pengambilan UJS</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/pengambilanujs') }}">Faktur Pelunasan</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/pengambilanujs') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pengambilan saldo UJS</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="sisa_ujs">Sisa Saldo</label>
                                    <input style="text-align: end;margin:right:10px" type="text" class="form-control"
                                        id="sisa_ujs" readonly name="sisa_ujs"
                                        value="{{ old('sisa_ujs', number_format($saldoTerakhir->latest()->first()->sisa_ujs, 2, ',', '.')) }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="saldo_masuk">Pengambilan UJS</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; margin:right:10px" type="text" class="form-control"
                                        readonly id="grand_total" name="grand_total" placeholder=""
    ...
    <script>
        ...
        $(document).ready(function() {
            // Mengambil nilai sisa saldo dari elemen dengan id sisa_ujs
            var sisaSaldoValue = $('#sisa_ujs').val();

            // Mengonversi nilai ke format rupiah
            var sisaSaldoRupiah = formatRupiahx(sisaSaldoValue);

            // Menetapkan nilai ke input sisa saldo
            $('#sisa_ujs').val(sisaSaldoRupiah);
        ...
        function updateSubTotal() {
            ...
            var sisaSaldo = parseCurrency($('#sisa_ujs').val());
            ...
            $('#grand_total').val("Rp " + subTotalRupiah);
        }
