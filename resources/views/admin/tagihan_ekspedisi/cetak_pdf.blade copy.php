...
<head>
    ...
    <style>
        ...
        .header {
            ...
            /* sesuaikan dengan warna latar belakang Anda */
            z-index: 1000;
            /* pastikan header muncul di atas konten lain */
        }

        /* Margin untuk menghindari tumpang tindih dengan konten */
        .body-content {
            margin-top: 115px;
...
<body style="margin: 0; padding: 0;">
                            ...
                            <tr>
                                ...
                                <td class="info-column">
                                    <span class="info-item"
                                        style="font-size: 11px;">{{ $cetakpdf->kode_tagihan }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="info-column">
    ...
    <div style="text-align: center;">
        ...
        <table style="width: 100%; border-top: 1px solid #000;" cellpadding="2" cellspacing="0">
            <tr>
                <td class="td" style="text-align: center; padding: 0px; font-size: 10px; width:3%">No.</td>
                <td class="td" style="text-align: left; padding: 0px; font-size: 10px; width:34%">Rute</td>
                <td class="td" style="text-align: left; padding: 0px; font-size: 10px; width:10%">Tgl. Kirim</td>
                <td class="td" style="text-align: left; padding: 0px; font-size: 10px; width:10%">No. Faktur</td>
                <td class="td" style="text-align: left; padding: 2px; font-size: 10px; width:14%">No. DO</td>
                <td class="td" style="text-align: left; padding: 0px; font-size: 10px; width:12%">No. PO</td>
                <td class="td" style="text-align: left; padding: 0px; font-size: 10px; width:9%">No. Mobil</td>
                <td class="td" style="text-align: left; padding: 0px; font-size: 10px; width:8%">Qty</td>
                <td class="td" style="text-align: right; font-size: 10px; width:10%">Harga</td>
                <td class="td" style="text-align: right; font-size: 10px; width:10%">Total</td>
            </tr>
