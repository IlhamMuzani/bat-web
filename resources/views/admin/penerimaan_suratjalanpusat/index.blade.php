...
@section('title', 'Penerimaan Surat Jalan Pusat')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Penerimaan Surat Jalan Pusat</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Penerimaan Surat Jalan Pusat</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Penerimaan Surat Jalan Pusat</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/penerimaansuratjalanpusat') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/penerimaansuratjalanpusat/unpostpenerimaansuratpusat/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/penerimaansuratjalanpusat/postingpenerimaansuratpusat/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
