...
@section('title', 'Inquery Pelunasan Faktur Pembelian Ban')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pelunasan Faktur Pembelian Ban</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_banpembelianlunas') }}">Inquery
                                pelunasan Faktur Pembelian Ban</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_banpembelianlunas/' . $inquery->id) }}" method="POST"
                enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Perbarui Pelunasan Faktur Pembelian Ban</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pelunasan Faktur Pembelian Ban <span>
                            </span></h3>
                                ...
                                @foreach ($details as $detail)
                                    <tr id="pembelian-{{ $loop->index }}">
                                        ...
                                        <td hidden>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    id="pembelian_ban_id-{{ $loop->index }}" name="pembelian_ban_id[]"
                                                    value="{{ $detail['pembelian_ban_id'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input onclick="MemoEkspedisi({{ $loop->index }})"
                                                    ...
                                                    id="kode_pembelian_ban-{{ $loop->index }}"
                                                    name="kode_pembelian_ban[]"
                                                    value="{{ $detail['kode_pembelian_ban'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                            ...
                            <tbody>
                                @foreach ($fakturs as $faktur)
                                    <tr onclick="getFaktur({{ $loop->index }})" data-id="{{ $faktur->id }}"
                                        data-kode_pembelian_ban="{{ $faktur->kode_pembelian_ban }}"
                                        ...
                                        <td class="text-center">{{ $loop->iteration }}</td>
                                        <td>{{ $faktur->kode_pembelian_ban }}</td>
                                        <td>{{ $faktur->tanggal }}</td>
                                        <td>{{ $faktur->supplier->nama_supp }}</td>
                                        {{-- <td>
                                            {{ $faktur->kode_pembelian_ban }}
                                        </td> --}}
                                        <td>
    ...
    <script>
        ...
        function itemPembelian(identifier, key, value = null) {
            var pembelian_ban_id = '';
            var kode_pembelian_ban = '';
            var tanggal_pembelian = '';
            var total = '';

            if (value !== null) {
                pembelian_ban_id = value.pembelian_ban_id;
                kode_pembelian_ban = value.kode_pembelian_ban;
            ...
            item_pembelian += '<input type="text" class="form-control" id="pembelian_ban_id-' + key +
                '" name="pembelian_ban_id[]" value="' +
                pembelian_ban_id +
                '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
            ...
            item_pembelian += '<div class="form-group">'
            item_pembelian +=
                '<input type="text" class="form-control" style="font-size:14px" readonly id="kode_pembelian_ban-' +
                key + '" name="kode_pembelian_ban[]" value="' +
                kode_pembelian_ban +
                '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
    ...
    <script>
        ...
        function getFaktur(rowIndex) {
            ...
            var pembelian_ban_id = selectedRow.data('id');
            var kode_pembelian_ban = selectedRow.data('kode_pembelian_ban');
            var tanggal_awal = selectedRow.data('tanggal_awal');
            var grand_total = selectedRow.data('grand_total');

            $('#pembelian_ban_id-' + activeSpecificationIndex).val(pembelian_ban_id);
            $('#kode_pembelian_ban-' + activeSpecificationIndex).val(kode_pembelian_ban);
