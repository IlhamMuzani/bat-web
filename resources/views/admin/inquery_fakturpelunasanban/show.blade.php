...
<div class="container">
    <a href="{{ url('admin/inquery_banpembelianlunas') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali </a>
    </a> <a href="{{ url('admin/faktur_pelunasanban/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
