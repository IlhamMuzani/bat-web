...
@section('title', 'Penerimaan Return Barang')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Penerimaan Return Barang</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/return_ekspedisi') }}">Penerimaan Return Barang</a>
                        </li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/return_ekspedisi') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div>
                    <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group d-flex">
                                            <input class="form-control" id="kode_pelanggan" name="kode_pelanggan"
                                                type="text" placeholder="" value="{{ old('kode_pelanggan') }}" readonly
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group d-flex">
                                            <input class="form-control" id="kode_driver" name="kode_driver"
                                                type="text" placeholder="" value="{{ old('kode_driver') }}" readonly
                                                style="margin-right: 10px;font-size:14px" />
                                            <button class="btn btn-primary" type="button"
                                                ...
                                                <div class="form-group">
                                                    <select style="font-size:14px" class="form-control" id="satuan-0"
                                                        ...
                                                        <option value="dus"
                                                            ...
                                                            dus</option>
                                                        <option value="kubik"
                                                            {{ old('satuan') == 'kubik' ? 'selected' : null }}>
                                                            kubik</option>
                                                    </select>
                                                </div>
                                            </td>
