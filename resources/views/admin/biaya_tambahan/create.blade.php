...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/biaya_tambahan') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_biaya" name="nama_biaya"
                                placeholder="masukkan nama biaya" value="{{ old('nama_biaya') }}">
                        </div>
                        <div class="form-group">
                            <label for="nominal">Nominal</label>
                            <input type="number" class="form-control" id="nominal" name="nominal"
                                placeholder="masukkan biaya" value="{{ old('nominal') }}">
                        </div>
                    </div>
                    <!-- Tambahkan ini di dalam card-footer -->
    ...
    $(document).ready(function() {
        ...
        $('#btnSimpan').click(function() {
            // Sembunyikan tombol dan tampilkan elemen loading
            $(this).hide();
            $('#loading').show();
