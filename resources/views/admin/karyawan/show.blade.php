                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                @if ($karyawan->ft_sim)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_sim) }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                @if ($karyawan->ft_kk)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_kk) }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                            ...
                            <div class="col-md-5">
                                @if ($karyawan->ft_kk_penjamin)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_kk_penjamin) }}"
                                        alt="tidak ada" height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @endif
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                @if ($karyawan->ft_skck)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_skck) }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                            ...
                            <div class="col-md-5">
                                @if ($karyawan->ft_surat_pernyataan)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_surat_pernyataan) }}"
                                        alt="tidak ada" height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                @if ($karyawan->ft_terbaru)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_terbaru) }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                            ...
                            <div class="col-md-5">
                                @if ($karyawan->ft_rumah)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_rumah) }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                @if ($karyawan->ft_penjamin)
                                    <img src="{{ asset('storage/uploads/' . $karyawan->ft_penjamin) }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
                                @else
                                    <img src="{{ asset('adminlte/dist/img/img-placeholder.jpg') }}" alt="tidak ada"
                                        height="300px" width="100px" class="w-100 rounded border">
