...
@section('title', 'Inquery Pembelian Ban')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pembelian Ban</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Inquery Pembelian Ban</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Inquery Pembelian Ban</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-primary"
                                                    href="{{ route('unpostban', ['id' => $pembelians->id]) }}">Ya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal fade" id="modal-posting-{{ $pembelians->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Posting pembelian pembelians
                                                    <strong>{{ $pembelians->kode_pembelian_ban }}</strong>?
                                                </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default"
                                                    data-dismiss="modal">Batal</button>
                                                <a class="btn btn-primary"
                                                    href="{{ route('postingban', ['id' => $pembelians->id]) }}">Ya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> --}}
