...
@section('title', 'Inquery Slip Gaji Mingguan')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Slip Gaji Mingguan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Inquery Slip Gaji Mingguan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Inquery Slip Gaji Mingguan</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <select class="custom-select form-control" id="kategori" name="kategori">
                                    ...
                                    <option value="slip_mingguan"selected>Slip Gaji Mingguan</option>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($slips->status == 'posting')
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/laporan_slipgaji/' . $slips->id) }}">Show</a>
                                            @endif
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery_slipgaji') }}";
            form.submit();
        }
    ...
    <script>
        ...
        function printSelectedData() {
            ...
            if (selectedIds.length === 0) {
                ...
                window.location.href = "{{ url('admin/cetak_gajifilter') }}?ids=" + selectedIdsString;
