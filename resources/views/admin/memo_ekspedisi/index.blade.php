...
@section('content')
                        ...
                        <div id="formmemotambahans" class="form-group" style="flex: 8;">
                            ...
                            <div class="form-group">
                                ...
                                <input style="font-size:14px" type="text" class="form-control" readonly id="kode_memosa"
                                    onclick="ShowMemo(this.value)" name="kode_memosa" placeholder=""
                                    value="{{ old('kode_memosa') }}">
                            </div>
                            <div class="form-group">
                                <label style="font-size:14px" for="nopol">Nama Sopir</label>
                                <input style="font-size:14px" type="text" class="form-control" readonly
                                    onclick="ShowMemo(this.value)" name="nama_driversa" id="nama_driversa" placeholder=""
                                    value="{{ old('nama_driversa') }}">
                            </div>
                            <div class="form-group" hidden>
                                <label style="font-size:14px" for="nopol">Telp</label>
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" readonly type="text"
                                    onclick="ShowMemo(this.value)" class="form-control" name="telps" id="telps"
                                    placeholder="" value="{{ old('telps') }}">
                            </div>
                            <div class="form-group" hidden>
                                ...
                                <input style="font-size:14px" style="font-size:14px" type="text" class="form-control"
                                    onclick="ShowMemo(this.value)" name="kendaraan_idsa" id="kendaraan_idsa" readonly
                                    placeholder="" value="{{ old('kendaraan_idsa') }}">
                            </div>
                            <div class="form-group">
                                <label style="font-size:14px" style="font-size:14px" for="nama">No Kabin</label>
                                <input style="font-size:14px" style="font-size:14px" readonly type="text"
                                    onclick="ShowMemo(this.value)" class="form-control" name="no_kabinsa"
                                    id="no_kabinsa" placeholder="" value="{{ old('no_kabinsa') }}">
                            </div>
                            <div class="form-group" hidden>
                                <label style="font-size:14px" style="font-size:14px" for="nama">No Pol</label>
                                <input style="font-size:14px" style="font-size:14px" readonly type="text"
                                    onclick="ShowMemo(this.value)" class="form-control" name="no_polsa" id="no_polsa"
                                    placeholder="" value="{{ old('no_polsa') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input style="font-size:14px" type="text" readonly class="form-control"
                                    onclick="ShowMemo(this.value)" name="nama_rutesa" id="nama_rutesa" placeholder=""
                                        ...
                                        <tr id="rute-0">
                                            ...
                                            <td style="width: 100px">
                                                <button style="margin-left:5px" type="button"
                                                    class="btn btn-danger btn-sm" onclick="removeBorong()">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input style=" font-size:14px;" type="text"
                                                                    class="form-control total_tarif2" readonly
                                                                    placeholder="" value="0 %">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input style="text-align: end; font-size:14px;"
                                                                    type="text" class="form-control" readonly
                                                                    id="uang_jaminan" name="uang_jaminan" placeholder=""
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input style="text-align: end; font-size:14px;"
                                                                    type="text" id="uangjaminanss" type="text"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="form-group">
                                                    <input style="font-size:14px; font-weight:bold; text-align:end"
                                                        readonly type="text" class="form-control" id="sub_totalborong"
                                                        name="sub_totalborong" value="{{ old('sub_totalborong') }}">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <select style="font-size:14px" class="form-control" id="satuans-0"
                                                        ...
                                                        <option value="">- Pilih -</option>
                                                        <option value="pcs"
                                                            {{ old('satuans') == 'pcs' ? 'selected' : null }}>
                                                            pcs</option>
                                                        <option value="ltr"
                                                            {{ old('satuans') == 'ltr' ? 'selected' : null }}>
                                                            ltr</option>
                                                        <option value="kg"
                                                            {{ old('satuans') == 'kg' ? 'selected' : null }}>
                                                            kg</option>
                                                        <option value="ton"
                                                            {{ old('satuans') == 'ton' ? 'selected' : null }}>
                                                            ton</option>
                                                        <option value="dus"
                                                            {{ old('satuans') == 'dus' ? 'selected' : null }}>
                                                            dus</option>
                                                        <option value="kubik"
                                                            {{ old('satuans') == 'kubik' ? 'selected' : null }}>
                                                            kubik</option>
                                                        <option value="malam"
                                                            {{ old('satuans') == 'malam' ? 'selected' : null }}>
                                                            malam</option>
                                                        <option value="hari"
                                                            {{ old('satuans') == 'hari' ? 'selected' : null }}>
                                                            hari</option>
                                                        <option value="minggu"
                                                            {{ old('satuans') == 'minggu' ? 'selected' : null }}>
                                                            minggu</option>
                                                    </select>
                                                </div>
                                            </td>
                                ...
                                <tbody>
                                    @foreach ($biayatambahan as $biayatambah)
                                        <tr onclick="getBiaya({{ $loop->index }})" data-id="{{ $biayatambah->id }}"
                                            ...
                                            data-nominal="{{ $biayatambah->nominal }}"
                            ...
                            <table id="datatables6" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($potonganmemos as $potonganmemo)
                                        <tr onclick="getPotongan({{ $loop->index }})"
                                            data-id="{{ $potonganmemo->id }}"
    ...
    <script>
        ...
        function updateSubTotals() {
            ...
            var satuPersenUangJaminan = 0 * UangJaminan;
