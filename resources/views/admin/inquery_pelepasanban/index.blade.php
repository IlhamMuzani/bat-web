...
@section('title', 'Inquery Pelepasan Ban')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pelepasan Ban</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Inquery Pelepasan Ban</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <tbody>
                                @foreach ($inquery as $pelepasan_ban)
                                    <tr id="editMemoekspedisi" data-toggle="modal"
                                        data-target="#modal-posting-{{ $pelepasan_ban->id }}" style="cursor: pointer;">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Hapus Pelepasan</h4>
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <form
                                                        action="{{ url('admin/inquery_pelepasanban/deleteban/' . $pelepasan_ban->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                    ...
                                    <div class="modal fade" id="modal-posting-{{ $pelepasan_ban->id }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Pelepasan Ban
                                                        <strong>{{ $pelepasan_ban->kode_pelepasan }}</strong>
                                                    </p>
                                                    @if ($pelepasan_ban->status == 'unpost')
                                                        ...
                                                        @if (auth()->check() && auth()->user()->fitur['inquery pelepasan ban posting'])
                                                            <form method="GET"
                                                                action="{{ route('postingpelepasan', ['id' => $pelepasan_ban->id]) }}">
                                                                <button type="submit"
                                                    ...
                                                    @if ($pelepasan_ban->status == 'posting')
                                                        ...
                                                        @if (auth()->check() && auth()->user()->fitur['inquery pelepasan ban unpost'])
                                                            <form method="GET"
                                                                action="{{ route('unpostpelepasan', ['id' => $pelepasan_ban->id]) }}">
                                                                <button type="submit"
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery_pelepasanban') }}";
            form.submit();
        }
    </script>
@endsection
