...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 20px;">LAPORAN SLIP GAJI KARYAWAN - RANGKUMAN</span>
        <br>
        <div class="text">
            @php
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 15px;">Nama
            </td>
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 15px;">Gaji
            </td>
        </tr>
        <!-- Separator row -->
        ...
        @foreach ($inquery as $slips)
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 15px;">
                    @if ($slips->perhitungan_gajikaryawan->user)
                ...
                <td class="td" style="text-align: right; padding: 5px; font-size: 15px;">
                    {{ number_format($slips->gajinol_pelunasan, 0, ',', '.') }}</td>
            </tr>
        @endforeach
        <!-- Separator row -->
        <tr style="border-bottom: 1px solid black;">
