...
<body style="margin-top: 10; padding: 0;">
    ...
    <table style="width: 100%; border-top: 1px solid #000;" cellpadding="2" cellspacing="0">
        {{-- <tr>
            ...
            <td class="td" style="text-align: left; padding: 0px; font-size: 12px">
                :</td>
            <td class="td" style="text-align: left; padding: 0px; font-size: 12px">5
            </td>
            <td class="td" style="text-align: left; font-size: 12px">x</td>
            <td class="td" style="text-align: left; font-size: 12px">Rp</td>
            <td class="td" style="text-align: left; font-size: 12px">105.000</td>
            <td class="td" style="text-align: left; font-size: 12px">=</td>
            <td class="td" style="text-align: left; font-size: 12px">Rp</td>
            <td class="td" style="text-align: left; font-size: 12px">525.000</td>
        </tr>
        ...
        <tr>
            ...
            <td class="td" style="text-align: right; font-size: 12px;">
                Rp </td>
            <td class="td" style="text-align: right; font-size: 12px;">
                {{ number_format($cetakpdf->_pelunasan_kasbon, 0, ',', '.') }} </td>
            </td>
            <td class="td" style="text-align: left; font-size: 12px;">
            </td>
            <td class="td" style="text-align: left; font-size: 12px;">
