...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        ...
        @if ($kategori == 'Pengambilan Kasbon')
            <span style="font-weight: bold; font-size: 20px;">LAPORAN PENGAMBILAN KASBON KARYAWAN - RANGKUMAN</span>
        @else
            <span style="font-weight: bold; font-size: 20px;">LAPORAN PENGEMBALIAN KASBON KARYAWAN - RANGKUMAN</span>
        @endif
        <br>
        <div class="text">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 15px;">Nominal
                Kasbon
            </td>
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 15px; color:white">a
            </td>
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 15px;">Total Kasbon
            </td>
        </tr>
        <!-- Separator row -->
        ...
        @foreach ($inquery as $item)
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 15px;">{{ $item->kode_kasbon }}
                </td>
