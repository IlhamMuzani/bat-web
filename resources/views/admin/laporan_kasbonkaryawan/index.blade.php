...
@section('title', 'Laporan Kasbon Karyawan')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Kasbon Karyawan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Kasbon Karyawan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Kasbon Karyawan</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="custom-select form-control" id="kategori" name="kategori">
                                    ...
                                    <option value="Pengambilan Kasbon" {{ Request::get('kategori') == 'Pengambilan Kasbon' ? 'selected' : '' }}>
                                        Pengambilan Kasbon
                                    </option>
                                    <option value="Pengembalian Kasbon" {{ Request::get('kategori') == 'Pengembalian Kasbon' ? 'selected' : '' }}>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporan_kasbonkaryawan') }}";
            form.submit();
        }
