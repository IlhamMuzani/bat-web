...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 18px;">LAPORAN PENJUALAN RETURN BARANG EKSPEDISI - RANGKUMAN</span>
        <br>
        <div class="text">
            @php
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        @foreach ($inquery as $faktur)
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 12px;">{{ $faktur->kode_penjualan }}
                </td>
