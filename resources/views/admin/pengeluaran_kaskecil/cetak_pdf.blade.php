...
<body style="margin: 0; padding: 0;">
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 0px; font-size: 15px; width:25%">Nama Akun</td>
            <td class="td" style="text-align: left; padding-right: 30px; font-size: 15px; width:40%">Keterangan</td>
        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="td" style="text-align: right; font-size: 15px; padding-right:9px">
