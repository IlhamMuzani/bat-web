...
<head>
    ...
    <title>Saldo Deposit Karyawan</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 17px;">SALDO PELUNASAN DEPOSIT KARYAWAN</span>
    </div>
    <div style="text-align: right;">
        <p style="font-size: 12px;">Tanggal : {{ \Carbon\Carbon::now()->format('d M Y') }}</p>
    </div>
    ...
    <table cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 12px;width: 85%  ">
                Rp. {{ number_format($inquery->sisa_kasbon, 2, ',', '.') }}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="td"
                ...
                ({{ terbilang($inquery->sisa_kasbon) }} Rupiah)
            </td>
