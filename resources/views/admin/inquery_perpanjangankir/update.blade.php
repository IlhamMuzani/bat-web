                    ...
                    <div class="card-body">
                        <div class="form-group" hidden>
                            ...
                            <input type="text" class="form-control" id="kendaraan_id" name="kendaraan_id" readonly
                                placeholder="Masukan kendaraan_id" value="{{ old('kendaraan_id', $inquery->nokir->kendaraan->id) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Perpanjangan BINA ANUGERAH TRANSINDO"
                                    {{ old('kategori', $inquery->nokir->kategori) == 'Perpanjangan BINA ANUGERAH TRANSINDO' ? 'selected' : null }}>
