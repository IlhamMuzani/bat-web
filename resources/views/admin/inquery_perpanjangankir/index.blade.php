                                            ...
                                            @if ($inquerys->status == 'unpost')
                                                ...
                                                @if (auth()->check() && auth()->user()->fitur['inquery perpanjangan kir update'])
                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/inquery_perpanjangankir/' . $inquerys->id . '/edit') }}">Update</a>
                                                @endif
                                                @if (auth()->check() && auth()->user()->fitur['inquery perpanjangan kir show'])
                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/inquery_perpanjangankir/' . $inquerys->id) }}">Show</a>
                                                @endif
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_perpanjangankir/unpostkir/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_perpanjangankir/postingkir/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
