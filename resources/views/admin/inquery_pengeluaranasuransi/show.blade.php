...
<head>
    ...
    <title>Faktur Pengambilan Uang Asuransi Barang</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">FAKTUR PENGAMBILAN UANG ASURANSI BARANG</span>
        <br>
        <br>
    </div>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td class="td" style="text-align: center; padding: 0px; font-size: 17px;">
                Kode Faktur:{{ $cetakpdf->kode_pengambilanasuransi }}</td>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td style="text-align: right; padding: 0px; font-size: 17px; font-weight:bold">Jumlah Kas Saldo : Rp.
                {{ number_format($cetakpdf->grand_total, 2, ',', '.') }}</td>
        </tr>
    </table>
    <div>
...
<div class="container">
    {{-- <a href="{{ url('admin/inquery_pengeluaranasuransi') }}" class="blue-button">Kembali</a> --}}
    <a href="{{ url('admin/inquery_pengeluaranasuransi') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali
    </a>
    <a href="{{ url('admin/pengambilan_asuransi/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
