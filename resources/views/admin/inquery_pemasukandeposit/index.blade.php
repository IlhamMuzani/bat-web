...
@section('title', 'Inquery Pemasukan Deposit Sopir')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pemasukan Deposit Sopir</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Inquery Pemasukan Deposit Sopir</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Inquery Pemasukan Deposit Sopir</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery_pemasukandeposit') }}";
            form.submit();
        }
    </script>
@endsection
