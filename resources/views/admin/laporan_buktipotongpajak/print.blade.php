...
<body style="margin: 0; padding: 0;">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 15px; color:white">a
            </td>
        ...
        @endforeach
        <tr>
            <td colspan="4" style="text-align: right; font-weight: bold; padding: 5px; font-size: 15px;">Sub Total
            </td>
