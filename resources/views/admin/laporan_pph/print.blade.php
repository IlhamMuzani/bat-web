...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 22px;">LAPORAN PPH - RANGKUMAN</span>
        <br>
        <div class="text">
            @php
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">No. Faktur
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">
                Tanggal
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">Pelanggan</td>
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 13px;">Pph</td>
        </tr>
        <!-- Separator row -->
        ...
        @foreach ($inquery as $pph)
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">{{ $pph->kode_faktur }}
                </td>
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">{{ $pph->tanggal_awal }}
                </td>
        ...
        <tr>
            ...
            <td style="text-align: right; font-weight: bold; padding: 5px; font-size: 13px;">
