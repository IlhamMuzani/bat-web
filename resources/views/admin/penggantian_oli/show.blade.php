...
<body style="margin: 0; padding: 0;">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 3px; font-size: 16px;">
                Tanggal:{{ $pembelians->tanggal_penggantian }}</td>
        </tr>
    </table>
    </div>
    {{-- <hr style="border-top: 0.1px solid black; margin: 1px 0;"> --}}
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 15px;">Jumlah Liter</td>
...
<div class="container">
    <a href="{{ url('admin/penggantian_oli') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/penggantian_oli/cetak-pdf/' . $pembelians->id) }}" class="blue-button">Cetak</a>
</div>
