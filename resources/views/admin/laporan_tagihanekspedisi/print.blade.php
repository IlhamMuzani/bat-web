...
<head>
    ...
    <title>Laporan Tagihan Ekspedisi</title>
    <style>
        html,
        body {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 22px;">LAPORAN TAGIHAN EKSPEDISI - RANGKUMAN</span>
        <br>
        <div class="text">
            @php
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 8; width: 10%;">
                Kategori
            </td>
        ...
        @foreach ($inquery as $faktur)
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 8;">{{ $faktur->kode_tagihan }}
                </td>
                <td class="td" style="text-align: left; padding: 5px; font-size: 8;">{{ $faktur->tanggal_awal }}
                </td>
                <td class="td" style="text-align: left; padding: 5px; font-size: 8;">{{ $faktur->kategori }}
                </td>
