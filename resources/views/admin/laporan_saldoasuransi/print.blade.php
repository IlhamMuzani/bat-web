...
<head>
    ...
    <title>Saldo Asuransi Barang</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">SALDO ASURANSI BARANG</span>
    </div>
    ...
    <table cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 12px;width: 85%  ">
                Rp. {{ number_format($inquery->sisa_usuransi, 0, ',', '.') }}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="td"
                ...
                ({{ terbilang($inquery->sisa_usuransi) }} Rupiah)
            </td>
