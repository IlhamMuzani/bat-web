...
@section('title', 'Laporan Perhitungan Gaji Bulanan')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Perhitungan Gaji Bulanan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Perhitungan Gaji Bulanan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Perhitungan Gaji Bulanan</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select class="custom-select form-control" id="statusx" name="statusx">
                                    ...
                                    <option value="memo_perjalanan" selected>Laporan Gaji Bulanan</option>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporan_perhitungangajibulanan') }}";
            form.submit();
        }
