...
<body style="margin-top: 0; padding: 0;">
    ...
    <div style="text-align: center; margin-top:9px">
        <span style="font-weight: bold; font-size: 14px;">REKAP GAJI STAFF KARYAWAN PT BINA ANUGERAH TRANSINDO(
            {{ \Carbon\Carbon::parse($cetakpdf->tanggal_awal)->locale('id')->isoFormat('D MMMM YYYY') }})</span>
        <div class="text">
            <p style="font-size: 12px">Periode:{{ $cetakpdf->periode_awal }}s/d {{ $cetakpdf->periode_akhir }}</p>
        </div>
    </div>
    ...
    <table style="width: 100%; border-top: 1px solid #000;" cellpadding="2" cellspacing="0">
        <tr>
            <td class="td" style="text-align: left; padding: 0px; font-size: 9px;  font-weight:bold; width:3%">
                NO.</td>
            <td class="td" style="text-align: left; padding: 0px; font-size: 9px;  font-weight:bold; width:11%">
                NAMA LENGKAP</td>
            <td class="td" style="text-align: right; padding: 0px; font-size: 9px;  font-weight:bold; ">
                GAPOK</td>
            <td class="td" style="text-align: right; padding: 0px; font-size: 9px;  font-weight:bold; ">
                HE</td>
            <td class="td" style="text-align: right; padding: 0px; font-size: 9px;  font-weight:bold; ">
                HK</td>
            <td class="td" style="text-align: center; padding: 0px; font-size: 9px;  font-weight:bold;">
                LEMBUR <span> <br>(JAM)</span></td>
            <td class="td" style="text-align: center; padding: 0px; font-size: 9px;  font-weight:bold;">
                STORING <span> <br>(JAM)</span></td>
            </td>
            <td class="td" style="text-align: right; font-size: 9px;  font-weight:bold;">GAJI KOTOR</td>
            <td class="td" style="text-align: center; padding: 0px; font-size: 9px; font-weight:bold; width:12%">
            ...
            <td class="td" style="text-align: right; padding: 0px; font-size: 9px;  font-weight:bold; ">
                PELUNASAN</td>
            <td class="td" style="text-align: right; font-size: 9px;  font-weight:bold; width:10%">GAJI BERSIH
            </td>
        </tr>
        ...
        @foreach ($details as $item)
            <tr>
                <td class="td" style="text-align: center; padding: 0px; font-size: 9px;">
                    {{ $loop->iteration }}
                </td>
                <td class="td" style="text-align: left; padding: 2px; font-size: 9px;">
                    {{ $item->nama_lengkap }}
                </td>
                <td class="td" style="text-align: right; padding: 0px; font-size: 9px;">
                ...
                <td class="td" style="text-align: center; padding: 1px; font-size: 9px;">
                    {{ $item->lembur }} jam
                </td>
                <td class="td" style="text-align: center; padding: 1px; font-size: 9px;">
                    {{ $item->storing }} jam
                </td>
                <td class="td" style="text-align: right; padding-right: 7px; font-size: 9px;">
                ...
                <td class="td" style="text-align: right; font-size: 9px;">
    ...
    <table style="width: 100%; border-top: 1px solid #000;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 0px; font-size: 9px;  font-weight:bold; width:15%">
                NAMA LENGKAP</td>
            <td class="td" style="text-align: right; padding: 0px; font-size: 9px;  font-weight:bold; width:5% ">
                KASBON</td>
            <td class="td" style="text-align: right; padding: 0px; font-size: 9px;  font-weight:bold; width:10% ">
                PELUNASAN</td>
            <td class="td" style="text-align: right; padding: 0px; font-size: 9px;  font-weight:bold; width:10% ">
                POTONGAN KE</td>
            <td class="td" style="text-align: right; font-size: 9px;  font-weight:bold; width:10%">SISA KASBON
            </td>
        </tr>
        <!-- Add horizontal line below this row -->
        <tr>
        ...
        @foreach ($details as $items)
            @if ($items->pelunasan_kasbon !== null && $items->pelunasan_kasbon != 0)
                <tr>
                    ...
                    <td class="td" style="text-align: right; padding: 0px; font-size: 9px;">
                        {{ number_format($items->potongan_ke, 0, ',', '.') }}
                    </td>
                    <td class="td" style="text-align: right; font-size: 9px;">
                        {{ number_format($items->kasbon_awal - $items->pelunasan_kasbon, 0, ',', '.') }}
                    </td>
                </tr>
                @php
                    $nomor_urut++;
