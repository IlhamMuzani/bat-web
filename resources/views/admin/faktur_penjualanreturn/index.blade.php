            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/return_ekspedisi') }}"> Faktur Penjualan
                                Return</a>
                        </li>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody id="tabel-pembelian">
                                <tr id="pembelian-0">
                                        ...
                                        <div class="form-group">
                                            <select style="font-size:14px" class="form-control" id="satuan-0"
                                                ...
                                                <option value="dus" {{ old('satuan') == 'dus' ? 'selected' : null }}>
                                                    dus</option>
                                                <option value="kubik" {{ old('satuan') == 'kubik' ? 'selected' : null }}>
                                                    kubik</option>
                                            </select>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control harga_jual"
    ...
    <script>
        ...
        function Hitung(startingElement) {
            $(document).on("input", startingElement, function() {
                ...
                // Remove dots and parse as float for harga_jual
