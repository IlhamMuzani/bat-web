...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="{{ url('admin/nokir/' . $nokir->id) }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nomor_uji_kendaraan" name="nomor_uji_kendaraan"
                                placeholder="Masukan nomor uji kendaraan"
                                value="{{ old('nomor_uji_kendaraan', $nokir->nomor_uji_kendaraan) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nomor_sertifikat_kendaraan"
                                ...
                                value="{{ old('nomor_sertifikat_kendaraan', $nokir->nomor_sertifikat_kendaraan) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdatetime">
                                <input type="date" id="tanggal_sertifikat" name="tanggal_sertifikat"
                                    ...
                                    value="{{ old('tanggal_sertifikat', $nokir->tanggal_sertifikat) }}"
                            ...
                            <select class="custom-select form-control" id="kendaraan_id" name="kendaraan_id"
                                ...
                                @foreach ($kendaraans as $kendaraan)
                                    <option value="{{ $kendaraan->id }}"
                                        {{ old('kendaraan_id', $nokir->kendaraan_id) == $kendaraan->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_rangka" name="no_rangka" readonly
                                placeholder="Masukan no rangka" value="{{ old('no_pol', $nokir->kendaraan->no_rangka) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_mesin" name="no_mesin" readonly
                                ...
                                value="{{ old('no_pol', $nokir->kendaraan->no_mesin) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="jenis_kendaraan" name="jenis_kendaraan"
                                ...
                                value="{{ old('jenis_kendaraan', $nokir->jenis_kendaraan) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="merek_kendaraan" name="merek_kendaraan"
                                ...
                                value="{{ old('merek_kendaraan', $nokir->merek_kendaraan) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="tahun_kendaraan" name="tahun_kendaraan">
                                <option value="">- Pilih -</option>
                                <option value="2025"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2025' ? 'selected' : null }}>
                                    2025</option>
                                <option value="2024"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2024' ? 'selected' : null }}>
                                    2024</option>
                                <option value="2023"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2023' ? 'selected' : null }}>
                                    2023</option>
                                <option value="2022"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2022' ? 'selected' : null }}>
                                    2022</option>
                                <option value="2021"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2021' ? 'selected' : null }}>
                                    2021</option>
                                <option value="2020"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2020' ? 'selected' : null }}>
                                    2020</option>
                                <option value="2019"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2019' ? 'selected' : null }}>
                                    2019</option>
                                <option value="2018"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2018' ? 'selected' : null }}>
                                    2018</option>
                                <option value="2017"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2017' ? 'selected' : null }}>
                                    2017</option>
                                <option value="2016"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2016' ? 'selected' : null }}>
                                    2016</option>
                                <option value="2015"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2015' ? 'selected' : null }}>
                                    2015</option>
                                <option value="2014"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2014' ? 'selected' : null }}>
                                    2014</option>
                                <option value="2013"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2013' ? 'selected' : null }}>
                                    2013</option>
                                <option value="2012"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2012' ? 'selected' : null }}>
                                    2012</option>
                                <option value="2011"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2011' ? 'selected' : null }}>
                                    2011</option>
                                <option value="2010"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2010' ? 'selected' : null }}>
                                    2010</option>
                                <option value="2009"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2009' ? 'selected' : null }}>
                                    2009</option>
                                <option value="2008"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2008' ? 'selected' : null }}>
                                    2008</option>
                                <option value="2007"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2007' ? 'selected' : null }}>
                                    2007</option>
                                <option value="2006"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2006' ? 'selected' : null }}>
                                    2006</option>
                                <option value="2005"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2005' ? 'selected' : null }}>
                                    2005</option>
                                <option value="2004"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2004' ? 'selected' : null }}>
                                    2004</option>
                                <option value="2003"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2003' ? 'selected' : null }}>
                                    2003</option>
                                <option value="2002"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2002' ? 'selected' : null }}>
                                    2002</option>
                                <option value="2001"
                                    {{ old('tahun_kendaraan', $nokir->tahun_kendaraan) == '2001' ? 'selected' : null }}>
                                    2001</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="bahan_bakar" name="bahan_bakar">
                                <option value="">- Pilih -</option>
                                <option value="Solar"
                                    {{ old('bahan_bakar', $nokir->bahan_bakar) == 'Solar' ? 'selected' : null }}>
                                    Solar</option>
                                <option value="Bensin"
                                    {{ old('bahan_bakar', $nokir->bahan_bakar) == 'Bensin' ? 'selected' : null }}>
                                    Bensin</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="berat_kosongkendaraan"
                                ...
                                value="{{ old('berat_kosongkendaraan', $nokir->berat_kosongkendaraan) }}">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="panjang" name="panjang"
                                        placeholder="Masukan panjang" value="{{ old('panjang', $nokir->panjang) }}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lebar" name="lebar"
                                        placeholder="Masukan lebar" value="{{ old('lebar', $nokir->lebar) }}">
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tinggi" name="tinggi"
                                        placeholder="Masukan tinggi" value="{{ old('tinggi', $nokir->tinggi) }}">
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="julur_depan" name="julur_depan"
                                        placeholder="Masukan julu depan"
                                        value="{{ old('julur_depan', $nokir->julur_depan) }}">
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="julur_belakang" name="julur_belakang"
                                        placeholder="Masukan julur belakang"
                                        value="{{ old('julur_belakang', $nokir->julur_belakang) }}">
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="daya_angkutorang" name="daya_angkutorang"
                                placeholder="Masukan daya angkut orang"
                                value="{{ old('daya_angkutorang', $nokir->daya_angkutorang) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kelas_jalan" name="kelas_jalan"
                                placeholder="Masukan kelas jalan" value="{{ old('kelas_jalan', $nokir->kelas_jalan) }}">
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="keterangan" name="keterangan">
                                ...
                                <option value="LULUS UJI BERKALA"
                                    {{ old('keterangan', $nokir->keterangan) == 'LULUS UJI BERKALA' ? 'selected' : null }}>
                                    LULUS UJI BERKALA</option>
                                <option value="TIDAK LULUS UJI BERKALA"
                                    {{ old('keterangan', $nokir->keterangan) == 'TIDAK LULUS UJI BERKALA' ? 'selected' : null }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_petugas_penguji"
                                ...
                                value="{{ old('nama_petugas_penguji', $nokir->nama_petugas_penguji) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nrp_petugas_penguji"
                                ...
                                value="{{ old('nrp_petugas_penguji', $nokir->nrp_petugas_penguji) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_kepala_dinas" name="nama_kepala_dinas"
                                ...
                                value="{{ old('nama_kepala_dinas', $nokir->nama_kepala_dinas) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pangkat_kepala_dinas"
                                ...
                                value="{{ old('pangkat_kepala_dinas', $nokir->pangkat_kepala_dinas) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nip_kepala_dinas" name="nip_kepala_dinas"
                                ...
                                value="{{ old('nip_kepala_dinas', $nokir->nip_kepala_dinas) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="unit_pelaksanaan_teknis"
                                ...
                                value="{{ old('unit_pelaksanaan_teknis', $nokir->unit_pelaksanaan_teknis) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_direktur" name="nama_direktur"
                                ...
                                value="{{ old('nama_direktur', $nokir->nama_direktur) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pangkat_direktur" name="pangkat_direktur"
                                placeholder="Masukan pangkat direktur"
                                value="{{ old('pangkat_direktur', $nokir->pangkat_direktur) }}">
                        </div>
                        <div class="form-group">
                            <label for="nip_kepala_dinas">NIP Direktur</label>
                            <input type="text" class="form-control" id="nip_direktur" name="nip_direktur"
                                placeholder="Masukan pangkat nip direktur"
                                value="{{ old('nip_direktur', $nokir->nip_direktur) }}">
                        </div>
                    </div>
