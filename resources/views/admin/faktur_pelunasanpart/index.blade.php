...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/faktur_pelunasanpart') }}">Faktur pelunasan
                                Pembelian
                                Part</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/faktur_pelunasanpart') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody id="tabel-pembelian">
                                <tr id="pembelian-0">
                                    ...
                                    <td hidden>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="pembelian_part_id-0"
                                                name="pembelian_part_id[]">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly
                                                type="text" class="form-control" id="kode_pembelianpart-0"
    ...
    <script>
        ...
        function itemPembelian(urutan, key, value = null) {
            ...
            item_pembelian += '<input type="text" class="form-control" id="pembelian_part_id-' + urutan +
                '" name="pembelian_part_id[]" value="' + pembelian_part_id + '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
            ...
            item_pembelian +=
                ...
                urutan +
                '" name="kode_pembelianpart[]" value="' + kode_pembelianpart + '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
    ...
    <script>
        ...
        function cekKodeFakturSudahAda(kodeFaktur) {
            var kodeFakturInputs = $('[id^=kode_pembelianpart-]').map(function() {
                return $(this).val();
            }).get();
