        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('admin/inquery_memoekspedisi') }}">Memo Ekspedisi</a>
                    </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group" hidden>
                                        ...
                                        <input type="text" class="form-control" id="no_pol" readonly name="no_pol"
                                            placeholder="" value="{{ old('no_pol', $inquery->no_pol) }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input onclick="showCategoryModalkendaraan(this.value)" style="font-size:14px"
                                            type="text" class="form-control" id="km" readonly name="km_awal"
                                            placeholder="" value="{{ old('km_awal', $inquery->km_awal) }}">
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input onclick="showCategoryModaldriver(this.value)" style="font-size:14px"
                                            type="tex" class="form-control" id="telp" readonly name="telp"
                                            placeholder="" value="{{ old('telp', $inquery->telp) }}">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input onclick="showCategoryModalrute(this.value)" style="font-size:14px"
                                            type="text" class="form-control" id="biaya" readonly name="uang_jalan"
                                            placeholder=""
                                ...
                                <tbody id="tabel-potongan">
                                    <tr id="potongan-0">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input onclick="potonganmemo(this.value)" style="font-size:14px"
                                                    type="text" class="form-control" readonly id="keteranganpotongan"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label style="font-size:14px; margin-top:5px" for="tarif">Uang
                                                            Jalan
...
var initialValue = {
    {
        old('deposit_driver', $inquery - > deposit_driver)
    }
};
