            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <a href="{{ url('admin/potongan_penjualan') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($potongan_penjualan->status == 'unpost')
                                                ...
                                                <a href="{{ route('postingpotongan', ['id' => $potongan_penjualan->id]) }}"
                                            ...
                                            @if ($potongan_penjualan->status == 'posting')
                                                ...
                                                <a href="{{ route('unpostpotongan', ['id' => $potongan_penjualan->id]) }}"
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                // Kirim permintaan AJAX untuk melakukan unpost
                $.ajax({
                    url: "{{ url('admin/inquery_potonganpenjualan/unposttagihan/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_potonganpenjualan/postingtagihan/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
