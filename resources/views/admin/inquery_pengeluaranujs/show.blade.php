...
<head>
    ...
    <title>Faktur Pengambilan UJS</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">FAKTUR PENGAMBILAN UJS</span>
        <br>
        <br>
    </div>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td class="td" style="text-align: center; padding: 0px; font-size: 17px;">
                Kode Faktur:{{ $cetakpdf->kode_pengambilanujs }}</td>
...
<div class="container">
    {{-- <a href="{{ url('admin/inquery_pengeluaranujs') }}" class="blue-button">Kembali</a> --}}
    <a href="{{ url('admin/inquery_pengeluaranujs') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali
    </a>
    <a href="{{ url('admin/pengambilan_ujs/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
