...
@section('title', 'Inquery Memo Asuransi Barang')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Memo Asuransi Barang</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                </div>
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_memoasuransi/' . $inquery->id) }}" method="POST"
                enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Inquery Memo Asuransi Barang</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div id="form_spk">
                            ...
                            <div class="form-group d-flex">
                                <input hidden onclick="showSpk(this.value)" class="form-control" id="spk_id"
                                    ...
                                    value="{{ old('spk_id', $inquery->spk->id ?? null) }}" readonly
                                    ...
                                    <div class="card-body">
                                        <div class="form-group" hidden>
                                            ...
                                            <input type="text" class="form-control" id="kendaraan_id" readonly
                                                ...
                                                value="{{ old('kendaraan_id', $inquery->kendaraan_id ?? null) }}">
                                        </div>
                                        <div class="form-group" hidden>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size:14px" type="text" class="form-control" id="golongan"
                                                ...
                                                value="{{ old('golongan', $inquery->kendaraan->golongan->nama_golongan ?? null) }}">
                                        </div>
                                        {{-- <div class="row"> --}}
                                        <div hidden class="form-group">
                                            ...
                                            <input style="font-size:14px" type="text" class="form-control"
                                                ...
                                                value="{{ old('km_awal', $inquery->kendaraan->km_awal ?? null) }}">
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group" hidden>
                                            ...
                                            <input type="text" class="form-control" id="user_id" readonly
                                                ...
                                                value="{{ old('user_id', $inquery->user_id ?? null) }}">
                                        </div>
                                        <div class="form-group" hidden>
                                            ...
                                            <input type="text" class="form-control" id="kode_driver" readonly
                                                ...
                                                value="{{ old('kode_driver', $inquery->user->karyawan->kode_karyawan ?? null) }}">
                                        </div>
                                        ...
                                        <div class="form-group d-flex">
                                            <input class="form-control" id="nama_driver" name="nama_driver"
                                                type="text" placeholder=""
                                                value="{{ old('nama_driver', $inquery->user->karyawan->nama_lengkap ?? null) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size:14px" type="tex" class="form-control"
                                                ...
                                                value="{{ old('telp', $inquery->user->karyawan->telp ?? null) }}">
                                        </div>
                                        <div hidden class="form-group">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group" hidden>
                                            ...
                                            <input type="text" class="form-control" id="rute_perjalanan_id" readonly
                                                ...
                                                value="{{ old('rute_perjalanan_id', $inquery->rute_perjalanan_id ?? null) }}">
                                        </div>
                                    ...
                                    <td hidden>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="tarif_asuransi_id"
                                                value="{{ old('tarif_asuransi_id', $inquery->tarif_asuransi_id ?? null) }}"
                                                name="tarif_asuransi_id">
                                        </div>
                                    </td>
                                    <td onclick="addTarifasuransi(this.value)">
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control" readonly
                                                ...
                                                value="{{ old('kode_tarif', $inquery->kode_tarif ?? null) }}">
                                        </div>
                                    </td>
                                    <td onclick="addTarifasuransi(this.value)">
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control" readonly
                                                ...
                                                value="{{ old('nama_tarif', $inquery->nama_tarif ?? null) }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text"
                                                ...
                                                name="nominal_tarif" data-row-id="0"
                                                value="{{ old('nominal_tarif', $inquery->nominal_tarif ?? null) }}">
                                        </div>
                                    </td>
                                    <td onclick="addTarifasuransi(this.value)">
                                        <div class="form-group">
                                            <input style="font-size:14px" readonly type="text"
                                                ...
                                                data-row-id="0" value="{{ old('persen', $inquery->persen ?? null) }}">
                                        </div>
                                    </td>
                                    <td onclick="addTarifasuransi(this.value)">
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control hasil_tarif"
                                                ...
                                                value="{{ old('hasil_tarif', $inquery->hasil_tarif ?? null) }}">
                                        </div>
                                    </td>
                                    <td style="width: 50px">
