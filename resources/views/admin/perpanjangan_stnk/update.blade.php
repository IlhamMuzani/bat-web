...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="{{ url('admin/perpanjangan_stnk/' . $stnk->id) }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_kabin" name="no_kabin" readonly
                                placeholder="Masukan no kabin" value="{{ old('no_pol', $stnk->kendaraan->no_kabin) }}">
                        </div>
                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group date" id="reservationdatetime">
                                                <input type="date" id="expired_stnk" name="expired_stnk"
                                                    ...
                                                    value="{{ old('expired_stnk', $stnk->expired_stnk) }}"
