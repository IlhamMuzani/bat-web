                    ...
                    <table id="datatables66" class="table table-bordered table-striped" style="font-size:15px">
                        ...
                        <tbody>
                            @php
                                ...
                                $totalTambahanMemo = 0; // Initialize total for memo tambahan
                                ...
                                $totalMemotambahan = 0; // Initialize the total variable for memotambahan
                            @endphp
                            ...
                            @foreach ($kendaraans as $kendaraan)
                                ...
                                @php
                                    ...
                                    foreach ($kendaraan->memo_ekspedisi as $memoEkspedisi) {
                                        $totalTambahanMemo += $memoEkspedisi->memotambahan
                                            ->whereBetween('created_at', [
                                                Carbon\Carbon::parse($created_at)->startOfDay(),
                                                Carbon\Carbon::parse($tanggal_akhir)->endOfDay(),
                                            ])
                                    ...
                                    echo number_format($totalTambahanMemo, 0, ',', '.');
                                    ...
                                    $subtotalDifference -=
                                        optional($kendaraan->memo_ekspedisi)
                                            ...
                                            ->sum('hasil_jumlah') ?? 0;
                                    $totalSubtotal += $subtotalDifference; // Accumulate the difference
                                @endphp
                            @endforeach
                        </tbody>
                        <tbody>
