...
<head>
    ...
    <title>Faktur Penerimaan Deposit Karyawan</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">FAKTUR PENERIMAAN DEPOSIT KARYAWAN</span>
        <br>
        <br>
    </div>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td style="text-align: right; padding: 0px; font-size: 17px; font-weight:bold">Jumlah Kas Saldo Deposit :
                Rp.
...
<div class="container">
    <a href="{{ url('admin/penambahan_saldokasbon') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/penambahan_saldokasbon/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
