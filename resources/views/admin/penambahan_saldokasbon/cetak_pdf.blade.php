...
<body style="margin: 0; padding: 0;">
    <div id="logo-container">
                            <img src="{{ public_path('storage/uploads/gambar_logo/Logo.jpg') }}"  alt="BAT" width="160"
            height="50">
    </div>
    <br>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td style="text-align: right; padding: 0px; font-size: 15px; font-weight:bold">Jumlah Saldo Deposit
                Karyawan:
                <span>
