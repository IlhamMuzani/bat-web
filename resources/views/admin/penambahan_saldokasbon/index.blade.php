...
@section('title', 'Faktur Penambahan Saldo Deposit Karyawan')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Faktur Penambahan Saldo Deposit Karyawan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/penambahan_saldokasbon') }}">Faktur Penambahan
                                Saldo Deposit Karyawan</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/penambahan_saldokasbon') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Penambahan Saldo Deposit Karyawan</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end;margin:right:10px" type="text" class="form-control"
                                        ...
                                        value="{{ old('sisa_kasbon', number_format($saldoTerakhir->latest()->first()->sisa_kasbon, 2, ',', '.')) }}"
                                        placeholder="">
                                </div>
                                <hr
