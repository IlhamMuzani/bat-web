...
<head>
    ...
    <title>Inquery Pelunasan Faktur Pembelian Part</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">PELUNASAN FAKTUR PEMBELIAN PART</span>
        <br>
    </div>
    <hr>
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td class="td" style="text-align: center; padding: 0px; font-size: 17px;">No.
                Faktur:{{ $cetakpdf->kode_pelunasanpart }}</td>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 17px;">Faktur Pembelian Part</td>
        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="td" style="text-align: center;  font-size: 17px;">{{ $item->kode_pembelianpart }}</td>
...
<div class="container">
    {{-- <a href="{{ url('admin/tablepelunasanpart') }}" class="blue-button">Kembali</a> --}}
    <a href="{{ url('admin/inquery_partpembelianlunas') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali </a>
    <a href="{{ url('admin/faktur_pelunasanpart/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
