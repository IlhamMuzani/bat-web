...
@section('title', 'Laporan Slip Gaji Bulanan')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Slip Gaji Bulanan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Slip Gaji Bulanan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Slip Gaji Bulanan</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="GET" id="form-action">
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                <label>Kategori Gaji Bulanan</label>
                                <select class="custom-select form-control" id="kategori" name="kategori">
                                    <option value="">- Pilih Kategori -</option>
                                    <option value="memo_perjalanans">Gaji Mingguan</option>
                                    <option value="memo_borongs"selected>Gaji Bulanan</option>
                                </select>
                            </div>
                            <div class="col-md-2 mb-3">
                                ...
                                <select class="custom-select form-control" id="statusx" name="statusx">
                                    ...
                                    <option value="memo_perjalanan">Laporan Gaji Bulanan Karyawan</option>
                                    <option value="memo_borong"selected>Laporan Slip Gaji Bulanan</option>
                                </select>
                            </div>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporan_slipgajibulanan') }}";
            form.submit();
        }
        ...
        function printReport() {
            ...
            if (startDate && endDate) {
                form.action = "{{ url('admin/print_slipgajibulanan') }}" + "?start_date=" + startDate + "&end_date=" +
                    endDate;
                form.submit();
            } else {
            ...
            $('#statusx').on('change', function() {
                ...
                switch (selectedValue) {
                    case 'memo_perjalanan':
                        ...
                        break;
                    case 'memo_borong':
                        window.location.href = "{{ url('admin/laporan_slipgajibulanan') }}";
                        break;
                    default:
