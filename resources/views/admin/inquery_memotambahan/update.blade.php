                    ...
                    <div class="card-body">
                        ...
                        <div id="formmemotambahans" class="form-group" style="flex: 8;">
                            ...
                            <div class="form-group">
                                ...
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" type="text"
                                    class="form-control" id="kode_memosa" name="kode_memosa" readonly placeholder=""
                                    value="{{ old('kode_memosa', $inquery->no_memo) }}">
                            </div>
                            <div class="form-group">
                                <label style="font-size:14px" for="nopol">Nama Sopir</label>
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" type="text"
                                    class="form-control" name="nama_driversa" id="nama_driversa" readonly placeholder=""
                                    value="{{ old('nama_driversa', $inquery->nama_driver) }}">
                            </div>
                            <div class="form-group" hidden>
                                <label style="font-size:14px" for="nopol">Telp</label>
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" type="text"
                                    class="form-control" name="telps" id="telps" readonly placeholder=""
                                    value="{{ old('telps', $inquery->telp) }}">
                            </div>
                            <div class="form-group" hidden>
                                <label style="font-size:14px" style="font-size:14px" for="nama">Kendaraan id</label>
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" style="font-size:14px"
                                    type="text" class="form-control" name="kendaraan_idsa" id="kendaraan_idsa"
                                    readonly placeholder="" value="{{ old('kendaraan_idsa', $inquery->kendaraan_id) }}">
                            </div>
                            <div class="form-group">
                                <label style="font-size:14px" style="font-size:14px" for="nama">No Kabin</label>
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" style="font-size:14px"
                                    type="text" class="form-control" name="no_kabinsa" id="no_kabinsa" readonly
                                    placeholder="" value="{{ old('no_kabinsa', $inquery->no_kabin) }}">
                            </div>
                            <div class="form-group" hidden>
                                <label style="font-size:14px" style="font-size:14px" for="nama">No Pol</label>
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" style="font-size:14px"
                                    type="text" class="form-control" name="no_polsa" id="no_polsa" readonly
                                    placeholder="" value="{{ old('no_polsa', $inquery->no_pol) }}">
                            </div>
                            <div class="form-group">
                                <label style="font-size:14px" for="nama">Rute Perjalanan</label>
                                <input onclick="ShowMemo(this.value)" style="font-size:14px" type="text"
                                    class="form-control" name="nama_rutesa" id="nama_rutesa" readonly placeholder=""
