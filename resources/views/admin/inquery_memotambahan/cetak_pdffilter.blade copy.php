...
<body style="margin: 0; padding: 0;">
    @for ($i = 0; $i < count($memos); $i +=2) @for ($j=$i; $j < $i + 2 && $j < count($memos); $j++) @php
        ...
        <div style="text-align: left; margin-left:5px">
            <span style="font-weight: bold; font-size: 15px;">{{ $cetakpdf->no_memo }}</span>
        </div>
        <table width="100%">
            <tr>
                <td style="width:60%;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="info-column">
                                <span class="info-item" style="font-size: 14px;">{{ $cetakpdf->kode_tambahan }}</span>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <div style="height: 330px; overflow: hidden;">
            ...
            <table style="width: 100%;" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td class="td" style="text-align: left; padding: 0px; font-size: 14px; width:50% ">
                        Keterangan</td>
                    <td class="td" style="text-align: left; padding: 0px; font-size: 14px; width:5% ">Qty</td>
                    <td class="td" style="text-align: left; padding: 0px; font-size: 14px; width:7%  ">Satuan
                    </td>
                    <td class="td" style="text-align: right; padding: 0px; font-size: 14px; width:20%  ">Harga
                    </td>
                    <td class="td" style="text-align: right; padding-right: 17px; font-size: 14px;  width:25% ">
                        Total</td>
                </tr>
