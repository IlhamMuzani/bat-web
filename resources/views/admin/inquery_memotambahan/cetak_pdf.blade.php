...
<body style="margin: 0; padding: 0;">
    ...
    <div style="text-align: center;">
        <span style="font-weight: bold; font-size: 20px;">PT BINA ANUGERAH TRANSINDO</span>
        <br>
            ...
            <td style="width:60%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="info-column">
                            <span class="info-item" style="font-size: 13px;">{{ $cetakpdf->kode_tambahan }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="info-column">
            ...
            <td style="width: 70%; text-align: left;">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 60%;">
                            <span class="info-item" style="font-size: 13px; text-align: left; display: inline-block;">:
                    ...
                    <tr>
                        <td style="width: 40%;">
                            <span class="info-item" style="font-size: 13px; text-align: left; display: inline-block;">No
                                Rekening</span>
                        </td>
                        <td style="width: 60%;">
                            <span class="info-item" style="font-size: 13px; text-align: left; display: inline-block;">:
