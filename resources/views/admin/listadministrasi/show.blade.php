...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">STRUK ADM(UJS)</span>
        <br>
        <br>
    </div>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td class="td" style="text-align: center; padding: 0px; font-size: 15px;">
                Kode Adm:{{ $cetakpdf->kode_jaminan }}</td>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td style="text-align: left; padding: 0px; font-size: 15px; font-weight:bold">Adm (Ujs)
                ({{ $cetakpdf->nama_sopir }})</td>
            <td style="text-align: right; padding: 0px; font-size: 15px; font-weight:bold">Nominal :
                <span>
                    Rp.{{ number_format($cetakpdf->nominal, 0, ',', '.') }}
            </td>
            </span>
        </tr>
    </table>
...
<div class="container">
    <a href="{{ url('admin/listadministrasi') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/listadministrasi/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
